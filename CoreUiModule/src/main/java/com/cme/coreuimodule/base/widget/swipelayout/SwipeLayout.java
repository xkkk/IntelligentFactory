package com.cme.coreuimodule.base.widget.swipelayout;
...
public class SwipeLayout extends FrameLayout {
    ...
    ViewDragHelper.Callback callback = new ViewDragHelper.Callback() {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            if(changedView == contentView) {
                ...
                deleteView.layout(newLeft,0, newLeft+deleteWidth,getHeight());
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        contentView.layout(0, 0, right, getHeight());
        deleteView.layout(right, 0, right + deleteWidth, getHeight());
    }
