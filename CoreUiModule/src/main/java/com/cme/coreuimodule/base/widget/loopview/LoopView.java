package com.cme.coreuimodule.base.widget.loopview;
...
/**
 * 自定义轮播图view
 * Created by xiaozi on 2017/11/29.
 */
...
public class LoopView extends LinearLayout {
    ...
    private void init(Context context) {
        LayoutInflater.from(context).inflate(R.layout.layout_loop, this);
        ...
        this.refreshHandler = new ScrollIndicateHandler(LoopView.this);
    }
    ...
    public void show() {
        ...
        LogUtils.i("cme","listSize=="+viewList.size());
    ...
    protected void refreshIndicateView() {
        ...
        for (int index = 0; index < totelCount; index++) {
            ...
            if (this.currentIndex == index) {
                ...
                imageView.setBackgroundResource(R.drawable.dot_un_selected);
                imageView.setLayoutParams(params);
            }
        }
    ...
    private static class ScrollIndicateHandler extends Handler {
        private final WeakReference<LoopView> scrollIndicateViewRef;

        public ScrollIndicateHandler(LoopView scrollIndicateView) {
            this.scrollIndicateViewRef = new WeakReference<LoopView>(
                    scrollIndicateView);
        ...
        public void handleMessage(Message msg) {
            ...
            LoopView scrollIndicateView = scrollIndicateViewRef.get();
