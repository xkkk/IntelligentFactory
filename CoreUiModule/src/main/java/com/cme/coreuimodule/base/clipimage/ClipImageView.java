package com.cme.coreuimodule.base.clipimage;
...
public class ClipImageView extends AppCompatImageView implements
    ...
    public void drawRectangleOrCircle(Canvas canvas) {
        ...
        if (mDrawCircleFlag) { // 画圆
            ...
            botton = mClipBorder.top + mClipBorder.right - 140;
//            RectF rectF = new RectF(mClipBorder.left+20, mClipBorder.top-100,  mClipBorder.right-20, botton);
            RectF rectF = new RectF(mClipBorder.left + 40, 200, mClipBorder.width(), 200 + mClipBorder.width() - 40);
            temp.drawRoundRect(rectF, mRoundCorner, mRoundCorner, transparentPaint);
//            temp.drawRect(mClipBorder.left+20, mClipBorder.top-100,  mClipBorder.right-20, botton,transparentPaint);
        }
