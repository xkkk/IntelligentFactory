...
public class CircleIndicator extends LinearLayout implements View.OnClickListener {
    ...
    private int mIndicatorBackgroundResId = R.drawable.white;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.dot_indicator_un_selected;
    ...
    private void createIndicators() {
        ...
        for (int i = 0; i < count; i++) {
            if (currentItem == i) {
                addIndicator(i, orientation, mIndicatorBackgroundResId, mImmediateAnimatorOut);
            } else {
    ...
    private void addIndicator(final int position, int orientation, @DrawableRes int backgroundDrawableId,
                              Animator animator) {
