...
public class BitmapUtils {
     ...
     * @param showNum
     */
    public static void setUnReadCount(ImageView imageView, int count, boolean showNum) {
        if (imageView == null) {
            return;
        }
        ...
        Bitmap result;
        if (showNum) {
            result = generatorNumIcon2(context, bitmap, true, String.valueOf(count));
        }else{
            result = generatorStatusIcon(bitmap,context.getResources(),Color.RED, SizeUtils.dp2px(context,6));
        }
