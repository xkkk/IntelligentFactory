...
public class CommonUtils {
    ...
    public static void openAppStore(Activity activity) {
        ...
        intent.setData(Uri.parse("market://details?id=" + CoreLib.getContext().getPackageName())); //跳转到应用市场，非Google Play市场一般情况也实现了这个接口
        //存在手机里没安装应用市场的情况，跳转会包异常，做一个接收判断
        if (intent.resolveActivity(CoreLib.getContext().getPackageManager()) != null) { //可以接收
